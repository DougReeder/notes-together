    ...
    <Box className="help" style={{flexGrow: 1, flexShrink: 1, width: '100%', overflowX: 'clip', overflowY: "auto"}}>
      <div style={{padding: '1rem', backgroundColor: 'white'}}>
        ...
        <p>When you edit a note on a device that is off-line, get the device back on-line (and give it ten seconds to sync)&nbsp;
          <i>before</i> editing the <em>same</em> note on a different device. Otherwise, the changes from one device may be lost.
        ...
        <h4>Is there a workaround if text can't be recognized accurately?</h4>
        <p>After tapping <b>Paste files & recognize text...</b>, select the camera and snap a photo. Select <b>Scattered Words</b> from the dialog. Read the text directly from the photo yourself — the recognized words are just there so the note can be found by searching.</p>
