      ...
      <div style={{padding: '1rem', backgroundColor: 'white'}}>
        ...
        <table className="shortcuts">
          ...
          <tbody>
            ...
            <tr><td>tab ⇥</td><td><ul style={{paddingInlineStart: '20px'}}><li>moves list item to sublist</li><li>moves cursor to next column in table</li><li>advances to next tab stop</li></ul></td></tr>
          </tbody>
        </table>
